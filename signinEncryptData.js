    ...
    ( async () => {
        ...
        const generatePostDataForSignIn = async (
            ...
            const prepareData = async (user_name, user_pass, encryptData) => {
                ...
                // 500 Internal Server Error, Lol may be reason in queryParams=${encodeURIComponent({})}.
                // const postData = `username=${user_name}&enc_password=${encodeURIComponent(enc_password)}&queryParams=${encodeURIComponent({})}&optIntoOneTap=${false}`;
            ...
            */
            ...
            const csrftoken = "EZx3cApITqj91L6fXj3pVPlyEGIVeY55"; // csrftoken(in cookie)/csrf_token(in html)/X-CSRFToken(in header)
